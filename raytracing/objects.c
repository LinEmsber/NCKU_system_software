...
FUNC_BEGIN(rectangular)
    ...
    // }
    COPY_POINT3(newNode->element.vertices[0], X->vertices[0]);
    COPY_POINT3(newNode->element.normal, X->normal);
    COPY_POINT3(newNode->element.vertices[1], X->vertices[1]);
    COPY_POINT3(newNode->element.normal, X->normal);
    COPY_POINT3(newNode->element.vertices[2], X->vertices[2]);
    COPY_POINT3(newNode->element.normal, X->normal);
    COPY_POINT3(newNode->element.vertices[3], X->vertices[3]);
    COPY_POINT3(newNode->element.normal, X->normal);
